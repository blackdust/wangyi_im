...
set :deploy_to, '/web/wangyi_im'
set :current_path, 'current'
set :repository, 'https://github.com/blackdust/wangyi_im.git'
set :branch, 'master'
set :user, 'root'
set :term_mode, nil
...
task :setup => :environment do
  ...
  order = MinaUtil::Builder.ask_mongoid('wangyi_im')
  ...
  nginx = MinaUtil::Builder.ask_nginx('wangyi_im', '/web/wangyi_im')
  queue! %[echo '#{nginx}' > "/etc/nginx/conf.d/wangyi_im.conf"]
  #test
  #queue! %[echo '#{nginx}' > "/home/dd/wangyi_im.conf"]
